  ...
  >
    ...
    >
      <div class="flex items-center justify-between px-4 sm:px-6 lg:px-12 py-3 lg:py-4">
        ...
        >
          <div class="relative">
            <p class="text-xl lg:text-3xl font-bold tracking-tight text-white group-hover:text-emerald-400 transition-colors duration-300">
              ryse<span class="beating-cursor text-emerald-400">_</span>
            </p>
            <div class="absolute inset-0 bg-emerald-400/20 blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"></div>
          </div>
        </RouterLink>

        <ul 
          v-if="!isMobile"
          class="flex items-center gap-6 lg:gap-4 text-sm lg:text-base"
        >
          <li v-for="link in navLinks" :key="link.path">
            ...
            >
              <span class="relative z-10 transition-all duration-300 group-hover:tracking-wider">
                {{ link.name }}
              </span>
              <div 
              ...
              <div class="absolute inset-0 bg-white/5 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 scale-95 group-hover:scale-100"></div>

              <div class="absolute bottom-1 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-emerald-400 to-cyan-400 rounded-full group-hover:w-full transition-all duration-300"></div>
            </RouterLink>
          </li>
        </ul>
        ...
        >
          ...
          <div class="absolute inset-0 bg-emerald-400/20 blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg"></div>
        </button>
      </div>
      ...
      >
        <div class="h-px bg-gradient-to-r from-transparent via-white/20 to-transparent mx-4"></div>
        ...
        <div class="px-4 py-4 space-y-1">
          ...
          >
            ...
            <div class="w-0 group-hover:w-4 overflow-hidden transition-all duration-300">
              <div class="w-4 h-0.5 bg-gradient-to-r from-emerald-400 to-cyan-400 rounded-full transform translate-x-1 group-hover:translate-x-0 transition-transform duration-300"></div>
            </div>
          </RouterLink>
        </div>
      </div>

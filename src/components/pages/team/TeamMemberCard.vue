...
<template>
    ...
    >
        <div
            class="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-cyan-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
        ></div>

        <div
            class="relative h-48 overflow-hidden bg-gradient-to-br from-emerald-400 to-cyan-500 p-1"
        >
            <div class="relative h-full w-full rounded-t-xl overflow-hidden">
                ...
                <div
                    class="absolute top-4 right-4 px-3 py-1 bg-blue-500/20 backdrop-blur-sm rounded-full border border-white/30"
                >
        ...
        <div class="relative p-6 space-y-4">
            ...
            <div v-if="props.linkedin || props.github" class="flex gap-3 justify-center pt-2">
                <a
                    ...
                    class="group/link flex items-center gap-2 px-4 py-2.5 bg-slate-800/50 hover:bg-emerald-500/20 border border-slate-700/50 hover:border-emerald-500/50 rounded-xl transition-all duration-300 text-slate-300 hover:text-emerald-400"
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    class="group/link flex items-center gap-2 px-4 py-2.5 bg-slate-800/50 hover:bg-cyan-500/20 border border-slate-700/50 hover:border-cyan-500/50 rounded-xl transition-all duration-300 text-slate-300 hover:text-cyan-400"
            ...
            ></div>
            <div
                class="absolute -top-2 -left-2 w-16 h-16 bg-gradient-to-br from-cyan-500/10 to-emerald-500/10 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"
            ></div>
        </div>

...
<template>
    <div class="flex flex-col items-center justify-center h-screen gap-8 p-4 bg-black">
        <img
            src="../assets/topography.svg"
            class="h-full w-full object-cover absolute invert-[50%] opacity-50 pointer-events-none"
        />
        <Card
            v-for="dev in devs"
            :key="dev.name"
